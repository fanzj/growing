...
public class RSA_Demo {
    ...
    public static void main(String[] args){
        Map<String, byte[]> map = RSA.generateKeyBytes();
        PublicKey publicKey = RSA.restorePublicKey(map.get(RSA.PUBLIC_KEY));
        PrivateKey privateKey = RSA.restorePrivateKey(map.get(RSA.PRIVATE_KEY));
        // 签名
